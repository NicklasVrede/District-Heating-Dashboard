"""
Groups filtered production data by plant name (vaerk_navn) and district.
Loads from production_filtered.csv, saves to production_grouped_by_vaerk.csv and production_grouped_by_district.csv
"""
