"""
Final grouping of production data by forsyid and year.
Groups plants with the same forsyid, summing production values and keeping relevant metadata.
Loads from filtered_geolocated_updated.csv, saves to filtered_final.csv
"""
...
print("Data has been saved to filtered_final.csv")