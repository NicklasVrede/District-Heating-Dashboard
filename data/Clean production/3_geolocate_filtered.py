"""
Geocodes postal codes and assigns forsyids by matching coordinates to geographical areas.
Loads from production_grouped_by_vaerk.csv, saves to filtered_geolocated.csv
"""
...
for index, row in plant_df.iterrows():
    postal_code = str(int(row['vaerk_postnr']))
...
# Convert vaerk_postnr to integer
plant_df['vaerk_postnr'] = plant_df['vaerk_postnr'].astype(int)
