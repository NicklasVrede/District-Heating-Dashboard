...
export const legendTooltips = {
    ...
    prices: {
        ...
        'Apartment': 'Yearly district heating price for apartments 70 m²',
        'House': 'Yearly district heating price for houses 130 m²'
    },
    productionTypes: {
        "Heating": "Total heat production in terajoules (TJ). This represents the thermal energy produced for district heating.",
        "Electricity": "Total electricity production in terajoules (TJ). This represents the electrical energy generated by the plant."
    }
}; 