...
# Function to get the first two words of a string in lowercase
def get_first_two_words_lowercase(text):
    return ' '.join(text.lower().split()[:2])
